    ...
    return (
      <section className="w-full max-w-7xl mx-auto px-3 xs:px-4 sm:px-6 lg:px-8 py-8 sm:py-12 bg-gray-50 relative overflow-hidden min-h-screen flex items-center">
        <div className="relative z-10 text-center py-8 sm:py-12 bg-white rounded-lg shadow-md border border-gray-200 w-full mx-2 sm:mx-0">
          <Loader2 className="w-8 h-8 sm:w-10 sm:h-10 text-yellow-600 animate-spin mx-auto mb-3" />
      ...
      <section className="w-full max-w-7xl mx-auto px-3 xs:px-4 sm:px-6 lg:px-8 py-8 sm:py-12 bg-gray-50 relative overflow-hidden min-h-screen flex items-center">
        <div className="relative z-10 text-center py-8 sm:py-12 bg-white rounded-lg shadow-md border border-gray-200 w-full mx-2 sm:mx-0">
          ...
          <button
            ...
            className="px-4 cursor-pointer py-2 sm:px-5 sm:py-2 bg-yellow-600 text-white rounded-lg font-medium hover:bg-yellow-700 transition-all duration-300 transform hover:scale-105 shadow-md text-sm sm:text-base"
          >
            Try Again
          </button>
        </div>
  ...
  return (
    <section className="w-full max-w-7xl mx-auto px-3 xs:px-4 sm:px-6 lg:px-8 py-5 sm:py-12 bg-gray-50 relative overflow-hidden min-h-screen flex items-center">
      ...
      <div className="absolute inset-0 pointer-events-none" style={{ zIndex: 1 }}>
        ...
        <div className="absolute top-20 sm:top-40 left-4 sm:left-10 w-20 h-20 sm:w-32 sm:h-32 bg-yellow-100 rounded-full mix-blend-multiply blur-xl opacity-70 animate-pulse"></div>
      ...
      <div className="relative z-10 w-full">
        ...
        >
          <motion.h2
            ...
            className="text-2xl xs:text-3xl sm:text-4xl font-bold text-yellow-600 leading-tight mb-3 sm:mb-4"
          >
          ...
          >
See what our travelers say about their remarkable safari and travel adventures.
          </motion.p>
        </motion.div>
        ...
        {testimonials.length === 0 ? (
          ...
          >
            <div className="w-12 h-12 sm:w-16 sm:h-16 bg-amber-100 rounded-full flex items-center justify-center mx-auto mb-3 sm:mb-4">
              <Quote className="w-6 h-6 sm:w-8 sm:h-8 text-yellow-600" />
            </div>
    ...
    >
      <div className="bg-white rounded-xl sm:rounded-2xl shadow-xl border border-gray-200 p-4 xs:p-6 sm:p-8 md:p-12 h-full flex flex-col">
        <Quote className="w-8 h-8 sm:w-10 sm:h-10 md:w-12 md:h-12 text-yellow-200 mb-4 sm:mb-6 flex-shrink-0" />
        ...
        <div className="flex flex-col xs:flex-row xs:items-center xs:justify-between gap-3 xs:gap-0 flex-shrink-0">
          <div className="flex items-center">
            <div className="w-10 h-10 sm:w-12 sm:h-12 md:w-14 md:h-14 bg-amber-100 rounded-full flex items-center justify-center mr-3 sm:mr-4 flex-shrink-0">
              <User className="w-5 h-5 sm:w-6 sm:h-6 md:w-7 md:h-7 text-yellow-600" />
            </div>
        ...
        <div className="h-1 bg-gradient-to-r from-yellow-600 to-amber-500 mt-4 sm:mt-6 rounded-full flex-shrink-0"></div>
      </div>
    </motion.div>
  </AnimatePresence>
</div>
            ...
            {testimonials.length > 1 && (
              <>
                <button
                  ...
                  className="absolute cursor-pointer left-0 top-1/2 -translate-y-1/2 -translate-x-2 xs:-translate-x-3 sm:-translate-x-4 md:-translate-x-12 w-8 h-8 xs:w-10 xs:h-10 sm:w-12 sm:h-12 bg-white rounded-full shadow-lg border border-gray-200 flex items-center justify-center hover:bg-yellow-50 hover:border-yellow-300 transition-all duration-300 hover:scale-110 z-10"
                  aria-label="Previous testimonial"
                >
                  <ChevronLeft className="w-4 h-4 xs:w-5 xs:h-5 sm:w-6 sm:h-6 text-yellow-600" />
                </button>
                
                <button
                  onClick={goToNext}
                  className="absolute cursor-pointer right-0 top-1/2 -translate-y-1/2 translate-x-2 xs:translate-x-3 sm:translate-x-4 md:translate-x-12 w-8 h-8 xs:w-10 xs:h-10 sm:w-12 sm:h-12 bg-white rounded-full shadow-lg border border-gray-200 flex items-center justify-center hover:bg-yellow-50 hover:border-yellow-300 transition-all duration-300 hover:scale-110 z-10"
                  aria-label="Next testimonial"
                >
                  <ChevronRight className="w-4 h-4 xs:w-5 xs:h-5 sm:w-6 sm:h-6 text-yellow-600" />
                </button>
              </>
            )}
